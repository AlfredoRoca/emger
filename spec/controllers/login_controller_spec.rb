...
RSpec.describe LoginController, :type => :controller do
  ...
  describe "POST #create (login)" do
    # let(:user) { create(:person, name: "pepe", lastname: "lopez", email: "qw@qwe.com", password: "1")}
    user = FactoryGirl.create(:person, password: "1")
  ...
  describe "DELETE #destroy (logout)" do
    # let(:user) { create(:person, name: "pepe", lastname: "lopez", email: "email@a.com", password: "1") }
    # user = FactoryGirl.create(:person, name: "pepe", lastname: "lopez", email: "email@a.com", password: "1")
